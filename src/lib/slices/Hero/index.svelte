			...
			<div class="col-start-1 md:row-start-1">
				...
				>
					{#if first_name_letters.length && last_name_letters.length}
						...
						<span class="block text-slate-700 -mt-[.2em]">
				...
				<span
					class="job-title block bg-gradient-to-tr from-yellow-600 via-yellow-300 to-yellow-600 bg-clip-text text-transparent text-2xl font-bold uppercase tracking-[.2em] md:text-4xl opacity-0"
				>
